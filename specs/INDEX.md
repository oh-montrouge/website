...
| File | Purpose |
|------|---------|
| [architecture/context-map.md](architecture/context-map.md) | Four sub-domain contexts, their language, relationships, and where later features land. Read before adding new entities or features. |
...
| [architecture/ddd-issues.md](architecture/ddd-issues.md) | Domain modeling gaps from DDD strategic and tactical review (bounded contexts, aggregate design, ubiquitous language). |
